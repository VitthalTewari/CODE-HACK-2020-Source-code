...
import com.google.android.exoplayer2.C1410C;
...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public Buffer writeDecimalLong(long j) {
        ...
        if (j >= 100000000) {
            i2 = j < 1000000000000L ? j < 10000000000L ? j < C1410C.NANOS_PER_SECOND ? 9 : 10 : j < 100000000000L ? 11 : 12 : j < 1000000000000000L ? j < 10000000000000L ? 13 : j < 100000000000000L ? 14 : 15 : j < 100000000000000000L ? j < 10000000000000000L ? 16 : 17 : j < 1000000000000000000L ? 18 : 19;
        } else if (j >= 10000) {
    ...
    private ByteString digest(String str) {
        try {
            ...
            return ByteString.m1605of(instance.digest());
    ...
    private ByteString hmac(String str, ByteString byteString) {
        try {
            ...
            return ByteString.m1605of(instance.doFinal());
        } catch (NoSuchAlgorithmException unused) {
            throw new AssertionError();
